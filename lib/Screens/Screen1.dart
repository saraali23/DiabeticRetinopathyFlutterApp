...
class _DRState extends State<Screen1> {
  @override
      ...
      color:   Color(0xff9589DE).withOpacity(0.5),
        ...
        Positioned(
            ...
            child: Container(
              ...
              height: 43,
              child: Text(
                "We help you to take care of your eyes",
                style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
          ...
          Positioned(
            ...
            child:   CircularPercentIndicator(
              ...
              center: GestureDetector(
                ...
                onTap: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>Screen2()));
                },
              ),
